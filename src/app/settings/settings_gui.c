...
void display_settings(const char *cur_ver, const char *new_ver, lv_scr_load_anim_t anim_type)
{
    ...
    lv_label_set_text(title_label, "#00ff00 H\tY\tH#");
    ...
    lv_label_set_text(qq_label, "SheWai\n20188619");
    ...
    {
        lv_label_set_text_fmt(new_ver_label, "Please update your  to #ff0000 %s#", new_ver);
    ...
    lv_label_set_text(author_label, "@HYH");
